 ...
 *  변경일     변경자  변경내역                       <br>
 *---------------------------------------------------------------------------------------<br>
 * 2014.07.11           최초 프로그램 작성         	  <br>     
 * 2014.07.21   이재빈 인수받아 이어서 작업       	  <br>     
 * 
 *---------------------------------------------------------------------------------------<br>
 * @namespace
 * @name ltsLm121
...
function cfnInitOnload()
{
    ...
    var oValidateSetList = [
        //{objid:"divSearch.cboSMART",    valid:"title:staSMART,req:true"},       // 검색영역:샘플유형
       // {objid:"divSearch.divAEDT.Calendar01",valid:"title:staAEDT,req:true"},	// 검색영역:최근수정일자(From)
       // {objid:"divSearch.divAEDT.Calendar00",valid:"title:staAEDT,req:true"},  // 검색영역:최근수정일자(To)
...
function cfnInitForm()
{
	...
	//divSearch.divAEDT.fnSetDay(gfnAddMonth(gfnToday(), -1), gfnToday());
	//divSearch.divVDAT.fnSetDay(gfnAddMonth(gfnToday(), -1), gfnToday());
